/* ==========================================================================
   Alin Mirza Portfolio – Interaction Layer
   ...
   - Flow field / ribbon aurora background
   - Lazy image loader (data-src)
   - Project filtering
   - Project modal details
   - Code snippet copy
   - Form validation + honeypot
   - Performance panel (toggle with window.__perf())
...
function initActiveNavHighlight() {
    ...
    function update() {
        ...
        for (const s of sections)
            if (pos >= s.offsetTop - 10) current = s.id;
